<div class="mw-content-panel mw-content-navigation-panel small-panel solid-panel tombooru-nav-panel single-item">
  ...
  <?= Template::getComponent('PortletTagTable', ['tagCategoryGroups' => !empty($setTags) ? $setTags : $post['tags'], 'isCategoryList' => false]); ?>
  <?= Template::getComponent('PortletSetList', ['post' => $post]); ?>
