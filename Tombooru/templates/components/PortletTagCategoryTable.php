...
<div class="tag-list tag-categories">
  <?php foreach ($tagCategories as $category): ?>
    <?php
      ...
      $categorySlug = $categoryIsGeneric ? '' : $category['slug'];
    ...
    <div class="tag-category-group">
      <div class="tag-category" data-tag-category="<?= htmlspecialchars($categorySlug); ?>" data-tag-color="<?= htmlspecialchars($categoryColor); ?>">
        <div class="tag-category-title tag-category-list">
          <h3 class="tag" data-tag-category="<?= htmlspecialchars($categorySlug); ?>">
